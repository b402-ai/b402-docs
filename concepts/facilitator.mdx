...
The [official b402 Facilitator](/facilitator) is currently live on BNB Chain mainnet and testnet, supporting BNB, USDT, USD1, and a growing list of BEP-20 tokens. Facilitator deployments are also extending coverage to other EVM networks such as Base. See the [Facilitator guide](/facilitator) for architecture details and integration examples.
