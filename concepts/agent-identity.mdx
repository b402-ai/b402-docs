...
The b402 ecosystem is expanding ERC-8004 integration to include:

- **Identity-gated endpoints**: Sellers can restrict access to agents with a minimum reputation score
- **Cross-protocol reputation**: Agent reputation portable across b402 and other ERC-8004 adopters
- **Automated delegation policies**: Smart contract rules governing when and how delegation is granted
- **Identity recovery**: Mechanisms to migrate an identity if the owner wallet is compromised
...
- [Smart Wallet Buyer Guide](/get-started/buyer-smart-wallet) - Agent payment walkthrough
