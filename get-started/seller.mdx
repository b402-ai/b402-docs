...
The **b402 protocol** enables you to monetize your APIs or web services with **gasless EVM-compatible token payments** on supported chains like BNB Chain and Base.
...
app.use(b402(
  { payTo: '0x...' }, // your wallet address on a supported chain (e.g., BNB Chain or Base)
  {
...
- Required amount
- Relayer contract address (e.g., 0xE1C2830d5DDd6B49E9c46EbE03a98Cb44CD8eA5a on BNB Chain)
- Description of the payment

After payment, verified details become available in the request object:

``` ts lines
req.b402.txHash  // transaction hash on the configured chain (e.g., BNB Chain or Base)
