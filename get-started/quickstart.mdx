...
B402 enables gasless payments on BSC using EIP-712 signatures. No BNB required for buyers or sellers.

<CardGroup cols={2}>
  <Card title="For Sellers" icon="store" href="/get-started/seller">
    Accept gasless payments from buyers
  </Card>
  <Card title="For Buyers" icon="wallet" href="/get-started/buyer">
    Send gasless payments to sellers
  </Card>
</CardGroup>
...
<Note>
  No API keys required. Just point your server at the facilitator and go live.
</Note>
...
<Steps>
  <Step title="Set Facilitator URL">
    Point your server at the facilitator
    ```javascript
  ...
  <Step title="Ship It">
    The facilitator verifies & settles payments on your behalf
  </Step>
</Steps>
...
const authorization = {
  ...
  value: ethers.parseUnits('10', 18), // 10 USD1
...
<CardGroup cols={2}>
  ...
  <Card title="Facilitator API" icon="server" href="/facilitator/introduction">
    Learn about the facilitator service
  </Card>
