...
<Note>
The Facilitator API today serves the **EVM stack** (Base + BNB). A Solana facilitator with HTTP-402 endpoints is on the roadmap. For Solana payments and private DeFi today, use the [`@b402ai/solana` SDK](/solana/sdk/installation) and hosted relayer directly.
</Note>
