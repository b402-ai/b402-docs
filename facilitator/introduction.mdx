...
The b402 Facilitator is the official facilitator service that processes b402 payments on the BNB Chain with one drop‑in endpoint. 

No API keys or blockchain connections are required.

For more information about the facilitator role, see Facilitator concept.
