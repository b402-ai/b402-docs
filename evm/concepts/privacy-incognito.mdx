...
Whitelisted tokens on the target chain can be shielded. See [Network & Token Support](/evm/concepts/network-token-support) for the current token list per chain.
...
- [Privacy Deep Dive](/evm/guides/privacy-incognito-deep-dive) - Commitments, nullifiers, and Merkle tree internals
