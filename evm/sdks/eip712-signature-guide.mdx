...
<Warning>
  Using the wrong decimals will cause the payment to fail or transfer an incorrect amount. Always verify decimals via [Network & Token Support](/evm/concepts/network-token-support).
</Warning>
...
- [Network & Token Support](/evm/concepts/network-token-support) - Supported tokens and addresses
