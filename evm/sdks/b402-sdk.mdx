...
Gas for all DeFi operations is sponsored by the facilitator. The standard b402 protocol fees apply to payments — see [Fee Structure](/evm/concepts/fees) for details.
