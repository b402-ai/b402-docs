...
<CardGroup cols={2}>
  <Card title="I'm building an AI agent" icon="robot" href="#b402-sdk">
    **@b402ai/sdk** - Private DeFi: shield, swap, lend, and transact — all gasless on Base.
  </Card>
...
The `@b402ai/sdk` gives agents private DeFi capabilities — shield tokens into a privacy pool, unshield to an anonymous smart wallet, then swap, lend, or execute arbitrary calls. All gasless.
...
See the [full SDK reference](/evm/sdks/b402-sdk) for constructor options, parameters, return types, and error handling.
...
See [Network & Token Support](/evm/concepts/network-token-support) for contract addresses and token details.
...
- [Architecture](/evm/architecture) - Understand how the layers fit together
- [Network & Token Support](/evm/concepts/network-token-support) - Contract addresses and chain details
- [Facilitator API Reference](/developers/facilitator/overview) - Direct API integration
- [EIP-712 Signature Guide](/evm/sdks/eip712-signature-guide) - Manual signature construction
