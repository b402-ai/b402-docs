---
title: b402 on EVM
description: "Gasless, confidential, multi-token agent payments on Base and BNB."
icon: star
---
...
| Privacy | None | [Privacy pool](/evm/concepts/privacy-incognito) integration (shield, transact, unshield) |
| Wallets | EOA only | EOA + [Smart Wallets](/evm/concepts/wallet) (ERC-7579 Nexus) |
| Gas | Gasless (USDC only, via EIP-3009) | Gasless (any whitelisted ERC-20, via [Relayer](/evm/concepts/relayer)) |
| Swaps | None | Integrated DEX swaps |
| Identity | None | [ERC-8004 agent identity](/evm/concepts/agent-identity) |
| Chains | Base (USDC only) | Multichain — [BNB Chain, Base](/evm/concepts/network-token-support), more planned |
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" href="/evm/quickstart">
    Send your first payment in under 5 minutes
  </Card>
  <Card title="Architecture" icon="book-open-cover" href="/evm/architecture">
  ...
  <Card title="EIP-712 Signatures" icon="code" href="/evm/sdks/eip712-signature-guide">
